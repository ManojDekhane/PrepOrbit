...
function ExamPage() {
  ...
  if (!user)
    return (
      <div className="p-6 text-center text-red-600 font-medium">
        ⚠️ Please login to attempt papers.
      </div>
    );
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 p-4 sm:p-6 max-w-7xl mx-auto bg-slate-50 min-h-screen">
      {/* Sidebar */}
      <div className="w-full lg:w-64 bg-white p-4 rounded shadow sticky top-20 h-fit">
        ...
        <div className="mt-4 space-y-1 text-sm">
          ...
          <div>
            <span className="inline-block w-4 h-4 bg-purple-400 rounded mr-2"></span>
            Marked
          </div>
          <div>
        ...
        <div className="text-center">
          <button
            ...
            className="mt-6 w-full bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded"
          >
        ...
        {/* Summary Panel */}
        {showSummary && (
          <div className="mt-4 bg-gray-50 border border-gray-300 rounded p-3 text-sm">
      ...
      <div className="flex-1 space-y-6">
          ...
          >
            ...
            {questions[currentQuestionIndex].imageUrl && (
              <img
                ...
                className="max-w-full h-auto my-3 rounded shadow"
              />
            )}
              ...
              {questions[currentQuestionIndex].options.map((opt) => (
                ...
                >
                  <input
                    ...
                    onChange={() =>
                      handleOptionChange(questions[currentQuestionIndex]._id, opt)
                    }
            ...
            <button
              onClick={() =>
                toggleMarkedForReview(questions[currentQuestionIndex]._id)
              }
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-4">
          <button
            ...
            className="w-full sm:w-auto bg-gray-300 hover:bg-gray-400 text-black px-4 py-2 rounded disabled:opacity-50"
